...
from analysis_variables import logreg_targets, linreg_targets, de_col_keys, de_col_values, outcome_cols, code_category_dict
...
if not os.path.isdir(f"../tables/linreg"):
    os.mkdir(f"../tables/linreg")
...
for target_name, target_function in linreg_targets.items():
    ...
    with open(f"../tables/ttest/{target_name}.txt", 'w') as f:
        ...
        try:
            ...
            output_summary.to_csv(f"../tables/linreg/{target_name} Feature Scores.csv")
