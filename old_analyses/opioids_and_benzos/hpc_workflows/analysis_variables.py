...
procedure_codes = {}
diagnosis_codes = [ #currently for opioid use
    "T400", # opium
    "T401", #heroin
    "T402", #other opioids
    "T404" #fentanyl, tramodol, or other synthetic
]
...
code_category_dict = {
    ...
    "Long-term Opioid Use": ["Z79891"],
    "Family History of Drug Abuse": ["Z813"],
    "Opioid Use Disorder": ["F11"],
    "Anxiety Disorder": ["F419"],
    "Recurrent Seizures": ["G40"],
    "Cocaine or Other Stimulant Use Disorder": ["F14", "F15"]
}
...
de_col_keys = [
    ...
    "Naloxone on Initial Visit"
]
de_col_values = {
    de_col_keys[0]: ["Concurrent Benzodiazepine Overdose", "No Concurrent Benzodiazepine Use"],
    de_col_keys[1]: ["Fentanyl Overdose", "No Fentanyl on Index Visit"],
    de_col_keys[2]: ["CT Obtained", "No CT Obtained"],
    de_col_keys[3]: ["Mechanical Ventilator Use", "No Mechanical Ventilator Use"],
    de_col_keys[4]: ["Naloxone Administered", "No Naloxone"],
    }
def data_enrichment_function(sedd, sasd, sid, sid_ed, codes, linker_table):
    code_types = {
        ...
        de_col_keys[1]: ["T4041"],
        de_col_keys[2]: [
            "70450", "70470", "70480", "70486", "71250","71260", "71270",
            "72192", "72193", "73700", "74150", "74160", "74170", "74176",
            "74177", "74178",
            "BW2"
        ],
        de_col_keys[3]: ["94669", "5A1945Z"],
        de_col_keys[4]: ["J2310", "HZ95ZZZ"],
    }
...
demographic_tables = [
    ...
    },
    {
        ...
        "save_filepath": f"../tables/Table 1 Admission Status.csv",
        "has_outcome_crosscomparison": False
    }
...
logreg_targets = {
    'Predictors of Benzodiazepine Co-Poisoning': \
        lambda dataset: dataset.loc[
            :,
            de_col_keys[0]
        ].eq(de_col_values[de_col_keys[0]][0]),
    'Predictors of Fentanyl Overdose': \
        lambda dataset: dataset.loc[
            :,
            de_col_keys[1]
...
outcome_cols = [
    ...
    {"name": de_col_keys[2], "type": "string", "positive_class": de_col_values[de_col_keys[2]]},
    {"name": de_col_keys[3], "type": "string", "positive_class": de_col_values[de_col_keys[3]]},
    {"name": de_col_keys[4], "type": "string", "positive_class": de_col_values[de_col_keys[4]]},
...
chart_plotting = [
    #benzo overdose
    {
        ...
        'title': 'Cost of Care for Patients with Benzodiazepine Poisoning on Initial Visit',
        'true_label': 'Benzodiazepine Co-Poisoning',
        'false_label': 'Opioid Overdose without Benzodiazepine',
        'logreg_key': 'Predictors of Benzodiazepine Co-Poisoning',
    },
    {
        'metric':'ED Readmissions',
        'y_axis_label': 'Repeat ED Visits per Patient',
        'title': 'Repeat ED Visit Rates for Patients with Benzodiazepine Poisoning on Initial Visit',
        'true_label': 'Benzodiazepine Co-Poisoning',
        'false_label': 'Opioid Overdose without Benzodiazepine',
        'logreg_key': 'Predictors of Benzodiazepine Co-Poisoning',
    },
    {
        ...
        'title': 'Repeat Hospitalization Rates for Patients with Benzodiazepine Poisoning on Initial Visit',
        'true_label': 'Benzodiazepine Co-Poisoning',
        'false_label': 'Opioid Overdose without Benzodiazepine',
        'logreg_key': 'Predictors of Benzodiazepine Co-Poisoning',
    },
    # Fentanyl
    {
        'metric':'Cost',
        'y_axis_label': 'Cost (USD)',
        'title': 'Cost of Care for Patients with Fentanyl Overdose on Initial Visit',
        'true_label': 'Fentanyl Overdose',
        'false_label': 'Non-Fentanyl Opioid Overdose',
        'logreg_key': 'Predictors of Fentanyl Overdose',
    },
    {
        'metric':'ED Readmissions',
        'y_axis_label': 'Repeat ED Visits per Patient',
        'title': 'Repeat ED Visit Rates for Patients with Fentanyl Overdose on Initial Visit',
        'true_label': 'Fentanyl Overdose',
        'false_label': 'Non-Fentanyl Opioid Overdose',
        'logreg_key': 'Predictors of Fentanyl Overdose',
    },
    {
        'metric':'Inpatient Readmissions',
        'y_axis_label': 'Repeat Hospitalizations per Patient',
        'title': 'Repeat Hospitalization Rates for Patients with Fentanyl Overdose on Initial Visit',
        'true_label': 'Fentanyl Overdose',
        'false_label': 'Non-Fentanyl Opioid Overdose',
        'logreg_key': 'Predictors of Fentanyl Overdose',
    }
